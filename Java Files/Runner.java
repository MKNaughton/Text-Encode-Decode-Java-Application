...
public class Runner {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * println("*                                                          *");
		 * System.out.
		 * println("*              Encoding Words with Suffixes                *");
		 * System.out.
		 * println("*                                                          *");
		 * System.out.println(
		 * "************************************************************");
		 ...
		 * System.out.println("(?) Optional Extras..."); System.out.println("(?) Quit");
		 * 
		 * //Output a menu of options and solicit text from the user
		 * System.out.print(ConsoleColour.BLACK_BOLD_BRIGHT);
		 * System.out.print("Select Option [1-?]>"); System.out.println();
		 * 
		 * 
	...
	public static void printProgress(int index, int total) {
		...
		char done = '#'; // Changed for compatibility in command prompt.
		char todo = '-'; // Changed for compatibility in command prompt.
